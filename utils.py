...
def get_fasttext_embeddings_and_features(df, ft_model):
    ...
    df['cosine_similarity'] = X_q1q2.apply(lambda x: compute_cosine_similarity(x['q1_embedding'], x['q2_embedding']),
                                           axis=1)
    df['euclidian_similarity'] = X_q1q2.apply(
        lambda x: compute_euclidean_similarity(x['q1_embedding'], x['q2_embedding']),
        axis=1)
    df['cityblock_similarity'] = X_q1q2.apply(
        lambda x: compute_cityblock_similarity(x['q1_embedding'], x['q2_embedding']),
        axis=1)
    df['minkowsky_similarity'] = X_q1q2.apply(
        lambda x: compute_minkowski_similarity(x['q1_embedding'], x['q2_embedding']),
        axis=1)
